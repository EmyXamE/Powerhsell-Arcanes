...
$preplog = "C:\MININT\SMSOSD\OSDLOGS\CreateFolderCustom.txt"
$destpath = $env:HOMEDRIVE + $env:HOMEPATH + "\Desktop\Installation [PXE]"
$sourcePath = "Z:\Install" #Dossier install a la raicne du DeploymentShare (lors de l'installation le DeploymentShare apparait comme disque Z)
...
Write-log "Script CreateFolder" $preplog
#creation repertoire 
New-Item -Path $destpath -ItemType Directory

#copy du dossier install du DeploymentShare vers le bureau du pc installe 
try {
    Copy-Item -Path "$sourcePath\*" -Destination $destpath -Recurse -Force
	Write-log "Copy files : OK" $preplog
} catch {
    Write-log "Erreur lors de la copie des fichiers : $_" $preplog 
    exit 1
}
# SIG # Begin signature block
# MIIZ9gYJKoZIhvcNAQcCoIIZ5zCCGeMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBdEgMkN9olberb
# dcbUlL2G36LQ4TcLdnaUSuaHnds4nKCCE+cwggX6MIIE4qADAgECAhMaAAAAGFwU
...
# BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgVNV0iHEIN8xemroasAMON3cuabEEuWH+
# 8blizkp0vw0wDQYJKoZIhvcNAQEBBQAEggEApcTJnGGFl8Kd4e3uabStTByNdpfI
# r7F+6WdBwYdVCTrE9aGeRR8lfgIu/0tfYKLQ7XMtvKNo81uO08ccoVl++vN6RdFV
# juIea9fgPGaERqPKrI5fvzHtD952/M3KrzhGsp4iVMfLZdF2DKPRK9uxe9bnisNd
# n2i88cdRfiavT0F1m9Tw+3TEPihVh1H6Cwim6L55kRf6q4MQoMeFl66JTsO4FpNj
# TgknQFa8Kpxt8DmQlngCjxSEXRJ6q4pydMyDew7oVDYoscGfry3Z1fi798nWiu9M
# JtwZdVRPn9jN1KAlUCmly/ROZ8f7kH/qNaNqlPavjdhXSj0fn1ujmP6VA6GCA0sw
...
# MjIzMzlaMD8GCSqGSIb3DQEJBDEyBDBA1P+Vg9uo4x+CqKOoWj44HNYjGjyjwR3h
# iDhGrHJSzMMDd8CyCC4k6jdysSzKhkswDQYJKoZIhvcNAQEBBQAEggIAW/xLZn+Y
# Tdt4D7ZfxzTbo3FjxvkmiTDyP7o3N81ES0dJwvWHzh/sRsat+GVQTY4XQgZ58MP7
# 5PCXMDlaSuFoHhxNAbuSSh3TRjOlom4JvDVYE71xcf1iZJg3Xgn5WsYswPi3G7uY
# b9WQdL4BUCRcq6T6k+MEK3mslXGGMZriQ3I2am0tuHE3BWddYcw7E1ROSXeffHsB
# /AdDx2IuxKVaw96F7sYP3catow6pw/pUVIw2WTxGgYK7o8OsN3FtDyBC8rp+WzbM
# dS8Jh7DwS6QgRwQKk2GIhQ0/wYLxxw6e7+GbODzSOAR8w6dC7jfDcJ3FauzgvuQU
# SpapWnKqPk3rkR19D/o0LR1KwTqnm6uyb0OzWzzqRjyuiasu1iA8SKsyVw3gkHAw
# oVnVR2ECF1UW4ODG0wIex6RT2iT9cHgZ5/wu59tR+o2kqGV9BD0J/cuW+CtNglVr
# pqzs6+vWYukASuNz4W4Mw3XVXU2MJasibkX0CdXDIrKjLb1DXoTGiuObSUQkhps/
# BLwird0tcPs7jQ0Fh6544WG2DJ6giY3Odst1RBVqq8mzzHSHyEfQupYNQhjXVitV
# l2y3GHU4gXT3x5QbD3T+/Jw8XkOkGTJ7vCoCM7o5tyPSG5Wz1wD0+LWFeKEWs7tG
# eYLlIeatQ1FUCXDovc8t5tIM1jm1Q5XnTXw=
