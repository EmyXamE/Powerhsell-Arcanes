$erreur = "init"
# Tant que les identifiants ne sont pas bons, on les redemande et on verifie l'authentification
while ($erreur -ne $null) {
    $erreur = $null
    # Compte du domaine Arcanes
...
# Modification des cles de registre
$RegPath = "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon"
Set-ItemProperty $RegPath -Name "AutoAdminLogon" -Value "1" -type String
Set-ItemProperty $RegPath -Name "DefaultUserName" -Value $ADUserLogin -type String
Set-ItemProperty $RegPath -Name "DefaultPassword" -Value $ADUserPassword -type String
Set-ItemProperty $RegPath -Name "DefaultDomainName" -Value "ARCANES" -type String

# SIG # Begin signature block
# MIIZ9gYJKoZIhvcNAQcCoIIZ5zCCGeMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCNtAznU3AFksoH
# su8nl6gTn1ti6Ea2NJrikDb5KKTCoaCCE+cwggX6MIIE4qADAgECAhMaAAAAGFwU
...
# BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg76HJvbNoHVAT9Fhz8BCGfOkkcDJiLpxJ
# rqLRd2JbNIIwDQYJKoZIhvcNAQEBBQAEggEAn71dBiX1g/gUrcTKtzWwmD0hbkqN
# dePZZRzl8M7d057qfU4uIcCuPE+J3BCN2v+uvdvrg/OQeqM6ckNw5lXWPT1VqBo6
# J6NLTEG4rkNyASVesWPyId31cW/IbF5/yWuwgrKcQPkivZzkjfYuLfmROgclmyPZ
# aNRBrK3QY7RWfSqfhPey1k5PanRmojCAx5xsG1HjpI4IdSxNtGAuH2g+M+fVtsAx
# pM45q5pZ421K/HVSrW3XQdjZUbqKdkaP3ffNQ4wWqoJfmEiIGxajm8uKDc7JJEl4
# 029aV5r/FOqXFeXUCD2opqsNjjWNNww6oCteh4u2KmgnCj4pDtq/0HSTB6GCA0sw
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNDA1MjIx
# MjUxNTZaMD8GCSqGSIb3DQEJBDEyBDBKd7Y2Wl3ZjhU+zniDX6W40PC432r26n4a
# oGgGgp2tD19H+MMThCYc/U7M1mVZa5EwDQYJKoZIhvcNAQEBBQAEggIAJ+YwfvkV
# nCNf3IXr+3TwJpkAAXtxyPDkIJ7l/Ww7KBKP9Kpa1TB5VBn4STTOpwpqgtAPd/UY
# +eNwq2HSYIZXXW8Bh48WVFYP3OfNrzHJI6dG7jAozu9MUf6q8eHK1VUk6T2Fu5iV
# 34ek/GtY+PFUF1pjnElSrva7dn7AlXQ31E3Alc3t+OY/ZDst9BMOMRHiqJ4pZezX
# /Tcvvv//K1RUr3+ITiL/oD3pg+GdvDl9NtxcHEzQpSUVfcprw1ZNbXyeLfCpgTy8
# gDlAqAPOwAIr/1E3owikWTPJBw/vHUWl9YUmgvr70SM3aZ4AThlgedbysJCwfwq7
# jT3gMEtFlDO0PMJhR1QF1TXSBEPXNtsBhRiQyZP8hrE/eudxHoVvaYe7/PlWOk8O
# T0F5d/m88ntEwoyw1j/k9+JPIuw9vFVh615/3/eCugDHbetCddWW9c+gGx1+0DRh
# DAL2qpDM7gx4DsqYl/bTaE8nKj88gTl7d9k+JK0dv1fNNn1Q1zdCSM47QH3ZZ5jW
# XS+kYiCPZNpuCo1PVdM+28eDIZXeO07IafMAxzPXlAr4B+W047uOz+AUYPOiQnMG
# Ylsdt4mC9F1376a7iXZS8h0LyfuF0I5KdZz6tO3mp/ZV/VidzSALbxE5yB4YBXRK
# QeMrrws22qvsRY1iHW8t7dLLqjj/l66ZeVE=
