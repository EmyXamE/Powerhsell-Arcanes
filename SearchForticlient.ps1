# Script pour chercher l executable du Forticlient et l executer
# Mbaptiste le 20/12/2023
# v1

# Les deux chemins ou l executable peut se trouver
$FirstPath = "$env:ProgramFiles\Fortinet\FortiClient\FortiClient.exe"
$SecondPath = "$env:ProgramFiles\Fortinet\FortiClient\FortiClient VPN\FortiClient.exe"

Write-host "Recherche du forticlient en cours" -ForegroundColor DarkGreen

Try {
    # Teste si l'executable est dans le premier chemin. Si il est ici, on l execute
    if (Test-Path $FirstPath) {
        Write-Host "FortiClient trouve" -ForegroundColor DarkGreen
        Start-Process -FilePath $FirstPath -NoNewWindow -ErrorAction Stop
    }
    # Teste si l'executable est dans le second chemin. Si il est ici, on l'execute
    elseif (Test-Path $SecondPath) {
        Write-Host "FortiClient trouve" -ForegroundColor DarkGreen
        Start-Process -FilePath $SecondPath -NoNewWindow -ErrorAction Stop
    }
    # Message d'erreur si l executable n est pas trouve
    else {
        Write-host "FortiClient non trouve : Veuillez contacter le service informatique." -ForegroundColor DarkRed
...
Catch {
    Write-Host "Une erreur s'est produite lors du lancement de FortiClient : $_" -ForegroundColor DarkRed
	Read-host "Appuyez sur entree pour sortir"
}
# SIG # Begin signature block
# MIIZ9gYJKoZIhvcNAQcCoIIZ5zCCGeMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBsIn01dTSG8Ha+
# OzscXVHBpEbDgjKeCESHO1dlHbBB9qCCE+cwggX6MIIE4qADAgECAhMaAAAAGFwU
...
# BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgl1gcGfYoTbjeGXkDe+/a2hbkiSI4EqDM
# UI4zYeNNR5EwDQYJKoZIhvcNAQEBBQAEggEA0NhY/4uC5OIZDiY0EvShPAwdqxel
# ORWMEJtBPra+soNlrXCscyQohYWRNHAmFTDR9+fUFxdzSLauCcPSJIaD47nNBDEH
# nyJILqgY0rTugjLnB7L2PvBG2gYovpBp3x55Dgy8iNFFCph4vau9Ag/kIm0KPo7J
# bJpqg/Yj45pQwVHA1stoE0fi50S85QXvEBOY4KEfdaMo/gkEKjruRQTyeAoDzQ5D
# cNKqoZFmSoRbBgTrbcbkcolwuNZNP5kAZdRZXiTLedssq0SUUjpGCU0a4wB9lxxH
# yQsrIYR6Pb/FczpEFrnG0Bq7YOpQhgKFeTmXRze/iNK4tbH9xAw0Nf3eLKGCA0sw
...
# NDAyNTlaMD8GCSqGSIb3DQEJBDEyBDCRn26Dcf822emy7w6zDSaZ2Ah39zfCj8aC
# FqVipSUCBsEnE26k6SBkssJOYVIMN4AwDQYJKoZIhvcNAQEBBQAEggIAOEvdFu4j
# zsuwfjY3cPazC0KwusFfa6/HvaDFYvf4CA2iMG10blDmOYmtF9Ndm4G22DANkCOf
# KpbP2etBZsGKBvKfP0oUHYPlobEZ2efFg//MPpHbswcwqjVu/1uaJNk9JMJ9zBSq
# rAlUJMk2hnEvVBD6aSdddHCgdRCCpjEnATIPjrCFjnnFhJDF2gkma0OrMEjMMlr2
# ALJzC9aNkYsFu8hoCTzK40xsap8LcvaMaqf2NIpuHWIgVU3CbEypEcFBKarlboT8
# AiE+VdgyGuSzqzzz13Aqq05+JQTrsY8uT2Nw9NzCxMrEzl2W+//Oo5DfHmq/MHPC
# jHQwnulW8ejqZQ9uTjFTGxtCUrPEz27xr3EVE4Wfq3q5/8P8kTo67X7EQibXS1dN
# qNUTPoaPy53Ghd1PuCXnCrRLXssAoaIsNlYr0CQiWDPXW9puG9hLmzg+fDUJKpPp
# pwXBmrDa+j22KhE1Sgw/h/RVpsYvXqWH2njTr1tZeaUBhF642xVizUCpC4T+qBwE
# F/pL2mF1LaOi8ycVUNSrle9riL1cdoct30EyVBNaRYbPDwunUwFFOtosEhcZ+ubw
# Z4+fJWC4Y7bK7lQtIcFcUnK9HpNghwkNW7ky9Ap+ACBrHtspWp00qfDyRlGyol/T
# eES2hu/aXHMFpeBVHtbialgDceRlvuNzgBg=
